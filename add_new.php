...
if(isset($_POST['submit'])){
    ...
    if ($result) {
        header("Location: index.php?msg=New record created successfully");# code...
    }
    else{
            ...
            <form action="" method="post" style="width: 50vh; min-width:300px;">
                 <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="first_name" placeholder="Eyob">
                    </div>

                    <div class="row mb-3">
                    <div class="col">
                        <label class="form-label">Last Name:</label>
                        <input type="text" class="form-control" name="last_name" placeholder="Mengecha">
                    </div>
                 </div>
